...
class F_14_00_REF_FINREP_3_0_UnionTable :
	...
	def calc_F_14_00_REF_FINREP_3_0_UnionItems(self) -> list[F_14_00_REF_FINREP_3_0_UnionItem] :
		...
		for item in F_14_00_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_14_00_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_14_00_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_14_00_REF_FINREP_3_0_Deposits_Table.Depositss:
			newItem = F_14_00_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_14_00_REF_FINREP_3_0_Base):
	...
	def ACCMLTD_CHNGS_FV(self):
		return self.ABSTRCT_INSTRMNT_RL.ACCMLTD_CHNGS_FV
	def ACCNTNG_CLSSFCTN(self):
	...
	def FV_HRRCHY(self):
		return self.ABSTRCT_INSTRMNT_RL.FV_HRRCHY
	def FV(self):
		return self.ABSTRCT_INSTRMNT_RL.FV
	def FV_CHNG(self):
		return self.ABSTRCT_INSTRMNT_RL.FV_CHNG
	pass
	CLLTRL = None # CLLTRL
	def FV(self):
