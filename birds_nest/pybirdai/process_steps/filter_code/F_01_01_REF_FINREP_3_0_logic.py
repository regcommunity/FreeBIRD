...
class F_01_01_REF_FINREP_3_0_UnionTable :
	...
	def calc_F_01_01_REF_FINREP_3_0_UnionItems(self) -> list[F_01_01_REF_FINREP_3_0_UnionItem] :
		...
		for item in F_01_01_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_01_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_01_01_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_01_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_01_01_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_01_01_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_01_01_REF_FINREP_3_0_Base):
	...
	def TYP_HDG(self):
		return self.ABSTRCT_INSTRMNT_RL.TYP_HDG
	PRTY = None # PRTY
	def INSTTTNL_SCTR(self):
		return self.PRTY.INSTTTNL_SCTR
	CLLTRL = None # CLLTRL
