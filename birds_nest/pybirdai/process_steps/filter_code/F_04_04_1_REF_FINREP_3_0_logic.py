...
class F_04_04_1_REF_FINREP_3_0_UnionTable :
	...
	def calc_F_04_04_1_REF_FINREP_3_0_UnionItems(self) -> list[F_04_04_1_REF_FINREP_3_0_UnionItem] :
		...
		for item in F_04_04_1_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_04_04_1_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_04_04_1_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_04_04_1_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_04_04_1_REF_FINREP_3_0_Base):
	...
	def ACCMLTD_PRTL_WRTFFS(self):
		return self.ABSTRCT_INSTRMNT_RL.ACCMLTD_PRTL_WRTFFS
	def ACCNTNG_CLSSFCTN(self):
	...
	def ACCMLTD_TTL_WRTFFS(self):
		return self.ABSTRCT_INSTRMNT_RL.ACCMLTD_TTL_WRTFFS
	def GRSS_CRRYNG_AMNT(self):
		return self.ABSTRCT_INSTRMNT_RL.GRSS_CRRYNG_AMNT
	def ACCMLTD_IMPRMNT(self):
		return self.ABSTRCT_INSTRMNT_RL.ACCMLTD_IMPRMNT
	def LW_CRDT_RSK_INDCTR(self):
		return self.ABSTRCT_INSTRMNT_RL.LW_CRDT_RSK_INDCTR
	PRTY = None # PRTY
	def ENTRPRS_SZ(self):
		return self.PRTY.ENTRPRS_SZ
	def INSTTTNL_SCTR(self):
