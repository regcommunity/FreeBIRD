...
class F_41_02_REF_FINREP_3_0_UnionTable :
	...
	def calc_F_41_02_REF_FINREP_3_0_UnionItems(self) -> list[F_41_02_REF_FINREP_3_0_UnionItem] :
		...
		for item in F_41_02_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_41_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_41_02_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_41_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_41_02_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_41_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_41_02_REF_FINREP_3_0_Deposits_Table.Depositss:
			newItem = F_41_02_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_41_02_REF_FINREP_3_0_Base):
	...
	def FVO_DSGNTN(self):
		return self.ABSTRCT_INSTRMNT_RL.FVO_DSGNTN
	pass
	CLLTRL = None # CLLTRL
	def CRRYNG_AMNT(self):
