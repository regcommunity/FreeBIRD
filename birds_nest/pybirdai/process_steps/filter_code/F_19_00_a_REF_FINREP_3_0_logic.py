...
class F_19_00_a_REF_FINREP_3_0_UnionTable :
	...
	def calc_F_19_00_a_REF_FINREP_3_0_UnionItems(self) -> list[F_19_00_a_REF_FINREP_3_0_UnionItem] :
		...
		for item in F_19_00_a_REF_FINREP_3_0_Debt_securities_Table.Debt_securitiess:
			newItem = F_19_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_19_00_a_REF_FINREP_3_0_Non_Negotiable_bonds_Table.Non_Negotiable_bondss:
			newItem = F_19_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		for item in F_19_00_a_REF_FINREP_3_0_Loans_and_advances_Table.Loans_and_advancess:
			newItem = F_19_00_a_REF_FINREP_3_0_UnionItem()
			newItem.base = item
			items.append(newItem)
		return items
...
class Loans_and_advances(F_19_00_a_REF_FINREP_3_0_Base):
	...
	def NN_PRFRMNG_PRR_FRBRNC_INDCTR(self):
		return self.ABSTRCT_INSTRMNT_RL.NN_PRFRMNG_PRR_FRBRNC_INDCTR
	def PRFRMNG_STTS_RSN(self):
		return self.ABSTRCT_INSTRMNT_RL.PRFRMNG_STTS_RSN
	PRTY = None # PRTY
	def INSTTTNL_SCTR(self):
		return self.PRTY.INSTTTNL_SCTR
	def ENTRPRS_SZ(self):
